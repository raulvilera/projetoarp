// Vercel Serverless Function — Handler nativo para receber respostas do formulário Lovable
// Usa a service role key no servidor (bypassa RLS do Supabase de forma segura)
